...
const Nav: React.FC = () => {
    ...
    const toggleSubDropdown1 = () => {
        setIsSubDropdownOpen1(!isSubDropdownOpen1);
    };
    ...
    return(
        <nav>
            ...
            <div className="md:hidden relative flex max-w-screen-md px-10 py-5 justify-between w-full">
                <img className="w-12" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&amp;shade=600" alt=""/>
                <div>
                    <button type="button" className="hs-collapse-toggle p-2 inline-flex justify-center items-center gap-x-2 rounded-lg border border-gray-200 bg-white text-gray-800 hover:bg-gray-50" data-hs-collapse="#navbar-with-collapse" aria-controls="navbar-with-collapse" aria-label="Toggle navigation" onClick={toggleMainDropdown}>
                    ...
                    {isMainDropdownOpen && (
                        <div  className="z-20 dropdown absolute top-20 left-0 w-full" id="myLinks">
                            <div className="px-10 py-5 bg-white border-t w-full"> 
                                <ul className="flex flex-col space-y-4 justify-around items-start w-full">
                                    <li className="p-2 flex justify-between w-full border-b hover:bg-gray-200 rounded-lg cursor-pointer" onClick={toggleSubDropdown1} >
                                        Solutions
                                            <svg className="w-2.5 h-2.5 ms-2.5 m-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"></path>
                                            </svg>
                                        {isSubDropdownOpen1 && (
                                            <div  className="z-10 dropdown absolute top-20 left-0 " id="Links">
                                                <div className="p-5 bg-white border-t"> 
                                                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-10">
                                                        <div className="p-5 rounded-lg hover:bg-gray-100">
                                                            <img src="/Icons/Graph.svg" alt="" className="w-10 bg-blue-700 rounded p-2"/>
                                    ...
                                    <li className="p-2 flex justify-between w-full border-b hover:bg-gray-200 rounded-lg cursor-pointer" onClick={toggleSubDropdown2}>
                                        More
                                        <svg className="w-2.5 h-2.5 ms-2.5 m-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"></path>
                                        </svg>
                                        {isSubDropdownOpen2 && (
                                            <div  className="z-10 dropdown absolute top-60 left-0 " id="Link">
                                                <div className="p-5 bg-white border-t"> 
                                                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-10">
                                                        <div className="p-5 rounded-lg hover:bg-gray-100">
                                                            <img src="/Icons/Graph.svg" alt="" className="w-10 bg-blue-700 rounded p-2"/>
